...
const HomePage = (props: Props) => {
  ...
  async function initModel() {
    // cocossd is used to create the model instance and then load it into the DOM as well
  ...
  }, [webcamRef,model, mirrored, autoRecordEnabled, runPrediction]);
  ...
  return (
     ...
     <>
      ...
      : <main className="flex  p-4 flex-col lg:flex">
      <div className=" pb-4 h-screen  lg:flex">
        ...
        <div className="border-primary/5 border-2 max-w-xs flex flex-col gap-2 justify-between shadow-md rounded-md p-4">
          ...
          <div className="flex flex-col gap-2">
            ...
            <Button
              ...
              className={autoRecordEnabled ? "bg-red-600 animate-pulse" : ""}
              size={"icon"}
  ...
  function userPromptRecord() {
    ...
    if (mediaRecorderRef.current?.state == "recording") {
      ...
      toast(isRecording ? "Recording has ended" : "Recording has started", {
